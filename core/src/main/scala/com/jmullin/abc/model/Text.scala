...
object Text {
  val full =
    """
      ...
      |like Google Maps, YouTube, Chrome, and Android. And we haven't stopped there.
      ...
      |What do we mean by far afield? Good examples are our health efforts:
      ...
      |In addition, with this new structure we plan to implement segment reporting for our Q4 results,
      |where Google financials will be provided separately than those for the rest of Alphabet businesses as a whole.
      |This new structure will allow us to keep tremendous focus on the extraordinary opportunities we have inside of Google.
      |A key part of this is Sundar Pichai. Sundar has been saying the things I would have said (and sometimes better!) for quite some time now,
      |and I've been tremendously enjoying our work together.
      ...
      |Recent launches like Google Photos and Google Now using machine learning are amazing progress.
      ...
      |I should add that we are not intending for this to be a big consumer brand with related products-the whole point is that Alphabet companies should have
      |independence and develop their own brands. We are excited about...
      ...
      |What could be better? No wonder we are excited to get to work with everyone in the Alphabet family.
      |Don't worry, we're still getting used to the name too!
    """.stripMargin

  val lines = full.split("\n").map(_.trim).toList.drop(1)
}
